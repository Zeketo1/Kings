  ...
  return (
    ...
    >
      <div className="flex flex-wrap justify-between gap-10 lg:w-full">
        <div className="flex-col gap-4 m w-fit sm:w-auto">
          <img src={Logo} alt="Logo" className="h-[45px]" />
        </div>
        <div className="flex flex-col w-[80px] gap-4 sm:w-auto">
          <h1 className="font-medium">Kings</h1>
          <div className="flex flex-col gap-4 w-full">
            <p onClick={() => scrollToElementWithOffset("#about", 100)}>
              About Us
            </p>
            <p
              onClick={() => {
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            <p onClick={() => scrollToElementWithOffset("#services", -240)}>
              Residential
            </p>
            <p onClick={() => scrollToElementWithOffset("#services", -240)}>
              Commercial
        ...
        <div className="flex flex-col w-[80px] gap-4">
